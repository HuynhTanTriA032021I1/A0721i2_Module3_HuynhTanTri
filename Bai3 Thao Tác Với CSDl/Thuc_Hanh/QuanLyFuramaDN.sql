...
WHERE SUBSTRING_INDEX(fullname, ' ', -1) REGEXP '^[HTK]' and LENGTH(fullname)<=15;
-- task 3
SELECT * from customer
WHERE YEAR(NOW()) - YEAR(birthday) BETWEEN 18 and 50 and
address = 'Crossing' or address= 'Quang Tri'
 -- tast 4
